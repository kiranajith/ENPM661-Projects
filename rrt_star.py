...
if __name__ == '__main__':
    ...
    # initial_state, goal_state = [50*constant.scaling, 180*constant.scaling, 0], [350*constant.scaling, 180*constant.scaling]
    # initial_state, goal_state = [50*constant.scaling, 180*constant.scaling, 0], [350*constant.scaling, 20*constant.scaling]
    ...
    # perform RRT_star
    search_radius = 20*constant.scaling
    rrt = RRT_star(start_node, goal_node, 5*constant.scaling, 2000, canvas, search_radius)
    path = rrt.planning()
    if path is None:
        print("No path!!")
